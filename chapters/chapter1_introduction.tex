...
The continued prevalence of reentrancy attacks despite significant academic attention \karthik{You need to first summarize this.} indicates fundamental gaps in both our understanding and our defensive capabilities. Three problems motivate this research.
...
For each incident, two researchers independently analyze the exploit transaction's call trace and token flows, identify the reentrancy pattern and vulnerability, and characterize the attack along multiple dimensions. This analysis employs an open coding methodology to develop a taxonomy of attack strategies, entry points, and scope classifications. \karthik{We should cite open-coding papers and ensure our methodology is in line with theirs. }Cross-validation ensures consistency and reduces bias.
...
\karthik{This is good, but then we need to update our findings and insights to include both the manual and automated analysis.}
