...
\end{itemize}
We describe our own experience with this manual analysis process in detail in Section~\ref{sec:meth-manual}, where we outline the steps involved in analyzing each incident in our dataset.
...
For each incident, two researchers independently analyze the exploit transaction's call trace and token flows, identify the reentrancy pattern and vulnerability, and characterize the attack along multiple dimensions. This analysis employs an open coding methodology~\cite{open-coding:strauss-corbin, open-coding:saldana} to develop a taxonomy of attack strategies, entry points, and scope classifications.
