...
Nearly a decade later, this assumption has not held in practice. Attacks have continued, evolved, and in many ways grown more sophisticated. The gap between the attention reentrancy receives in security education and its continued exploitation in practice motivates the empirical investigation at the core of this thesis.
