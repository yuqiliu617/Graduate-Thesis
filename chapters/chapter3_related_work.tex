...
This process is time-intensive---a single complex attack can require days of expert analysis. Security firms like BlockSec~\cite{attack-report:hype-beans} and SlowMist~\cite{attack-report:lendf-me, attack-report:revest-finance} regularly publish post-mortem analyses, but the manual nature limits throughput.
