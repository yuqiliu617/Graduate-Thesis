...
Following transaction analysis, we employ an open coding approach~\cite{open-coding:strauss-corbin, open-coding:saldana} to develop attack taxonomies. We first define initial codes reflecting specific exploit structures observed, then iteratively generalize by merging codes with shared underlying mechanisms.
